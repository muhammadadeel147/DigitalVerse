    ...
    <section id="services" className="section-padding !pt-16 md:!pt-20 relative overflow-hidden bg-gradient-to-b from-background to-muted/20 scroll-mt-24">
      ...
      <div className="container-custom relative z-10" ref={ref}>
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-foreground mt-4 mb-6 leading-tight tracking-tight">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="relative h-full overflow-hidden rounded-3xl border border-border/70 bg-card/90 p-8 shadow-[0_16px_40px_-28px_rgba(15,23,42,0.35)] transition-all duration-300 hover:-translate-y-1 hover:border-primary/25 hover:shadow-[0_28px_60px_-32px_rgba(15,23,42,0.42)]">
                ...
                <div className="relative z-10 flex items-start justify-between gap-4">
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-border/60 bg-muted/50 text-primary shadow-sm">
                ...
                <h3 className="relative z-10 mt-6 text-xl font-semibold text-foreground tracking-tight">
                  {service.title}
                </h3>
                ...
                <div className="relative z-10 mt-8 flex items-end justify-between border-t border-border/60 pt-5">
                  <div>
                    <div className="text-2xl font-bold text-foreground tracking-tight">{service.stats.value}</div>
